...
var MobileMenu = function () {
    function MobileMenu() {
        ...
        this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); // selects the menu div that we are clicking
        this.menuContent = (0, _jquery2.default)(".site-header__menu-content"); //selects the hidden div that we want to display when it's clicked
        this.events();
    }
...
var RevealOnScroll = function () {
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function createWaypoints() {
            var that = this; //sets the new this for the DOM
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            this.openModalButton.click(this.openModal.bind(this)); //.bind(this) binds this to this
        ...
        value: function openModal() {
            ...
            return false; //stops the href="#" from causing browser to autpomatically scrolling to the top of the page
        }
    }, {
        key: "closeModal",
